...
module ExploringInterpreterOutput 
    ( Explorer
    , execute
    , executeAll
    , revert
...
displayExecEnv :: (Show p, Show o) => Gr () (p,o) -> String
displayExecEnv = ExplorerM.displayExecEnv

subExecEnv :: Explorer p c o -> Gr () (p,o)
subExecEnv = ExplorerM.subExecEnv

getPathFromRootToCurr :: Explorer p c o -> Gr () (p, o)
